...
void main() {
	...
	`}function $u(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,d=l===_r||l===yr,c=l===cn||l===hn;if(d||c){let h=e.get(o);const f=h!==void 0?h.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new eo(n)),h=d?t.fromEquirectangular(o,h):t.fromCubemap(o,h),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),h.texture;if(h!==void 0)return h.texture;{const m=o.image;return d&&m&&m.height>0||c&&m&&s(m)?(t===null&&(t=new eo(n)),h=d?t.fromEquirectangular(o):t.fromCubemap(o),h.texture.pmremVersion=o.pmremVersion,e.set(o,h),o.addEventListener("dispose",r),h.texture):null}}}return o}function s(o){let l=0;const d=6;for(let c=0;c<d;c++)o[c]!==void 0&&l++;return l===d}function r(o){const l=o.target;l.removeEventListener("dispose",r);const d=e.get(l);d!==void 0&&(e.delete(l),d.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function Yu(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&Dn("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function ju(n,e,t,i){const s={},r=new WeakMap;function a(h){const f=h.target;f.index!==null&&e.remove(f.index);for(const x in f.attributes)e.remove(f.attributes[x]);f.removeEventListener("dispose",a),delete s[f.id];const m=r.get(f);m&&(e.remove(m),r.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(h,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,t.memory.geometries++),f}function l(h){const f=h.attributes;for(const m in f)e.update(f[m],n.ARRAY_BUFFER)}function d(h){const f=[],m=h.index,x=h.attributes.position;let _=0;if(m!==null){const T=m.array;_=m.version;for(let M=0,S=T.length;M<S;M+=3){const L=T[M+0],P=T[M+1],R=T[M+2];f.push(L,P,P,R,R,L)}}else if(x!==void 0){const T=x.array;_=x.version;for(let M=0,S=T.length/3-1;M<S;M+=3){const L=M+0,P=M+1,R=M+2;f.push(L,P,P,R,R,L)}}else return;const p=new(qo(f)?Jo:Zo)(f,1);p.version=_;const u=r.get(h);u&&e.remove(u),r.set(h,p)}function c(h){const f=r.get(h);if(f){const m=h.index;m!==null&&f.version<m.version&&d(h)}else d(h);return r.get(h)}return{get:o,update:l,getWireframeAttribute:c}}function Ku(n,e,t){let i;function s(f){i=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,m){n.drawElements(i,m,r,f*a),t.update(m,i,1)}function d(f,m,x){x!==0&&(n.drawElementsInstanced(i,m,r,f*a,x),t.update(m,i,x))}function c(f,m,x){if(x===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,m,0,r,f,0,x);let p=0;for(let u=0;u<x;u++)p+=m[u];t.update(p,i,1)}function h(f,m,x,_){if(x===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let u=0;u<f.length;u++)d(f[u]/a,m[u],_[u]);else{p.multiDrawElementsInstancedWEBGL(i,m,0,r,f,0,_,0,x);let u=0;for(let T=0;T<x;T++)u+=m[T]*_[T];t.update(u,i,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=d,this.renderMultiDraw=c,this.renderMultiDrawInstances=h}function Zu(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(r/3);break;case n.LINES:t.lines+=o*(r/2);break;case n.LINE_STRIP:t.lines+=o*(r-1);break;case n.LINE_LOOP:t.lines+=o*r;break;case n.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function Ju(n,e,t){const i=new WeakMap,s=new ot;function r(a,o,l){const d=a.morphTargetInfluences,c=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,h=c!==void 0?c.length:0;let f=i.get(o);if(f===void 0||f.count!==h){let y=function(){N.dispose(),i.delete(o),o.removeEventListener("dispose",y)};var m=y;f!==void 0&&f.texture.dispose();const x=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,u=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],M=o.morphAttributes.color||[];let S=0;x===!0&&(S=1),_===!0&&(S=2),p===!0&&(S=3);let L=o.attributes.position.count*S,P=1;L>e.maxTextureSize&&(P=Math.ceil(L/e.maxTextureSize),L=e.maxTextureSize);const R=new Float32Array(L*P*4*h),N=new $o(R,L,P,h);N.type=li,N.needsUpdate=!0;const b=S*4;for(let C=0;C<h;C++){const B=u[C],V=T[C],Y=M[C],W=L*P*4*C;for(let q=0;q<B.count;q++){const K=q*b;x===!0&&(s.fromBufferAttribute(B,q),R[W+K+0]=s.x,R[W+K+1]=s.y,R[W+K+2]=s.z,R[W+K+3]=0),_===!0&&(s.fromBufferAttribute(V,q),R[W+K+4]=s.x,R[W+K+5]=s.y,R[W+K+6]=s.z,R[W+K+7]=0),p===!0&&(s.fromBufferAttribute(Y,q),R[W+K+8]=s.x,R[W+K+9]=s.y,R[W+K+10]=s.z,R[W+K+11]=Y.itemSize===4?s.w:1)}}f={count:h,texture:N,size:new ke(L,P)},i.set(o,f),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let x=0;for(let p=0;p<d.length;p++)x+=d[p];const _=o.morphTargetsRelative?1:1-x;l.getUniforms().setValue(n,"morphTargetBaseInfluence",_),l.getUniforms().setValue(n,"morphTargetInfluences",d)}l.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}return{update:r}}function Qu(n,e,t,i){let s=new WeakMap;function r(l){const d=i.render.frame,c=l.geometry,h=e.get(l,c);if(s.get(h)!==d&&(e.update(h),s.set(h,d)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==d&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),s.set(l,d))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==d&&(f.update(),s.set(f,d))}return h}function a(){s=new WeakMap}function o(l){const d=l.target;d.removeEventListener("dispose",o),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:r,dispose:a}}const ol=new pt,so=new sl(1,1),ll=new $o,dl=new Md,cl=new tl,ro=[],ao=[],oo=new Float32Array(16),lo=new Float32Array(9),co=new Float32Array(4);function gn(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let r=ro[s];if(r===void 0&&(r=new Float32Array(s),ro[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(r,o)}return r}function ct(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ht(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Ss(n,e){let t=ao[e];t===void 0&&(t=new Int32Array(e),ao[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function ef(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function tf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ct(t,e))return;n.uniform2fv(this.addr,e),ht(t,e)}}function nf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ct(t,e))return;n.uniform3fv(this.addr,e),ht(t,e)}}function sf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ct(t,e))return;n.uniform4fv(this.addr,e),ht(t,e)}}function rf(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ct(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ht(t,e)}else{if(ct(t,i))return;co.set(i),n.uniformMatrix2fv(this.addr,!1,co),ht(t,i)}}function af(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ct(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ht(t,e)}else{if(ct(t,i))return;lo.set(i),n.uniformMatrix3fv(this.addr,!1,lo),ht(t,i)}}function of(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ct(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ht(t,e)}else{if(ct(t,i))return;oo.set(i),n.uniformMatrix4fv(this.addr,!1,oo),ht(t,i)}}function lf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function df(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ct(t,e))return;n.uniform2iv(this.addr,e),ht(t,e)}}function cf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ct(t,e))return;n.uniform3iv(this.addr,e),ht(t,e)}}function hf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ct(t,e))return;n.uniform4iv(this.addr,e),ht(t,e)}}function uf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function ff(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ct(t,e))return;n.uniform2uiv(this.addr,e),ht(t,e)}}function pf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ct(t,e))return;n.uniform3uiv(this.addr,e),ht(t,e)}}function mf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ct(t,e))return;n.uniform4uiv(this.addr,e),ht(t,e)}}function gf(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(so.compareFunction=Xo,r=so):r=ol,t.setTexture2D(e||r,s)}function vf(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||dl,s)}function xf(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||cl,s)}function _f(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||ll,s)}function yf(n){switch(n){case 5126:return ef;case 35664:return tf;case 35665:return nf;case 35666:return sf;case 35674:return rf;case 35675:return af;case 35676:return of;case 5124:case 35670:return lf;case 35667:case 35671:return df;case 35668:case 35672:return cf;case 35669:case 35673:return hf;case 5125:return uf;case 36294:return ff;case 36295:return pf;case 36296:return mf;case 35678:case 36198:case 36298:case 36306:case 35682:return gf;case 35679:case 36299:case 36307:return vf;case 35680:case 36300:case 36308:case 36293:return xf;case 36289:case 36303:case 36311:case 36292:return _f}}function bf(n,e){n.uniform1fv(this.addr,e)}function wf(n,e){const t=gn(e,this.size,2);n.uniform2fv(this.addr,t)}function Sf(n,e){const t=gn(e,this.size,3);n.uniform3fv(this.addr,t)}function Ef(n,e){const t=gn(e,this.size,4);n.uniform4fv(this.addr,t)}function Mf(n,e){const t=gn(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Tf(n,e){const t=gn(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Af(n,e){const t=gn(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Rf(n,e){n.uniform1iv(this.addr,e)}function Cf(n,e){n.uniform2iv(this.addr,e)}function Pf(n,e){n.uniform3iv(this.addr,e)}function Lf(n,e){n.uniform4iv(this.addr,e)}function Df(n,e){n.uniform1uiv(this.addr,e)}function If(n,e){n.uniform2uiv(this.addr,e)}function Uf(n,e){n.uniform3uiv(this.addr,e)}function Nf(n,e){n.uniform4uiv(this.addr,e)}function Ff(n,e,t){const i=this.cache,s=e.length,r=Ss(t,s);ct(i,r)||(n.uniform1iv(this.addr,r),ht(i,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||ol,r[a])}function Of(n,e,t){const i=this.cache,s=e.length,r=Ss(t,s);ct(i,r)||(n.uniform1iv(this.addr,r),ht(i,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||dl,r[a])}function kf(n,e,t){const i=this.cache,s=e.length,r=Ss(t,s);ct(i,r)||(n.uniform1iv(this.addr,r),ht(i,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||cl,r[a])}function Bf(n,e,t){const i=this.cache,s=e.length,r=Ss(t,s);ct(i,r)||(n.uniform1iv(this.addr,r),ht(i,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||ll,r[a])}function zf(n){switch(n){case 5126:return bf;case 35664:return wf;case 35665:return Sf;case 35666:return Ef;case 35674:return Mf;case 35675:return Tf;case 35676:return Af;case 5124:case 35670:return Rf;case 35667:case 35671:return Cf;case 35668:case 35672:return Pf;case 35669:case 35673:return Lf;case 5125:return Df;case 36294:return If;case 36295:return Uf;case 36296:return Nf;case 35678:case 36198:case 36298:case 36306:case 35682:return Ff;case 35679:case 36299:case 36307:return Of;case 35680:case 36300:case 36308:case 36293:return kf;case 36289:case 36303:case 36311:case 36292:return Bf}}class Hf{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=yf(t.type)}}class Vf{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=zf(t.type)}}class Gf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],i)}}}const sr=/(\w+)(\])?(\[|\.)?/g;function ho(n,e){n.seq.push(e),n.map[e.id]=e}function Wf(n,e,t){const i=n.name,s=i.length;for(sr.lastIndex=0;;){const r=sr.exec(i),a=sr.lastIndex;let o=r[1];const l=r[2]==="]",d=r[3];if(l&&(o=o|0),d===void 0||d==="["&&a+2===s){ho(t,d===void 0?new Hf(o,n,e):new Vf(o,n,e));break}else{let h=t.map[o];h===void 0&&(h=new Gf(o),ho(t,h)),t=h}}}class ps{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);Wf(r,a,this)}}setValue(e,t,i,s){const r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&i.push(a)}return i}}function uo(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Xf=37297;let qf=0;function $f(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const fo=new Ie;function Yf(n){Ve._getMatrix(fo,Ve.workingColorSpace,n);const e=`mat3( ${fo.elements.map(t=>t.toFixed(4))} )`;switch(Ve.getTransfer(n)){case vs:return[e,"LinearTransferOETF"];case $e:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function po(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+$f(n.getShaderSource(e),o)}else return r}function jf(n,e){const t=Yf(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Kf(n,e){let t;switch(e){case Jl:t="Linear";break;case Ql:t="Reinhard";break;case ed:t="Cineon";break;case td:t="ACESFilmic";break;case nd:t="AgX";break;case sd:t="Neutral";break;case id:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ls=new O;function Zf(){Ve.getLuminanceCoefficients(ls);const n=ls.x.toFixed(4),e=ls.y.toFixed(4),t=ls.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Jf(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Sn).join(`
`)}function Qf(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function ep(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=n.getActiveAttrib(e,s),a=r.name;let o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function Sn(n){return n!==""}function mo(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function go(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const tp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Qr(n){return n.replace(tp,np)}const ip=new Map;function np(n,e){let t=Ne[e];if(t===void 0){const i=ip.get(e);if(i!==void 0)t=Ne[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Qr(t)}const sp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vo(n){return n.replace(sp,rp)}function rp(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function xo(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function ap(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Do?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Il?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===si&&(e="SHADOWMAP_TYPE_VSM"),e}function op(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case cn:case hn:e="ENVMAP_TYPE_CUBE";break;case bs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function lp(n){let e="ENVMAP_MODE_REFLECTION";return n.envMap&&n.envMapMode===hn&&(e="ENVMAP_MODE_REFRACTION"),e}function dp(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case No:e="ENVMAP_BLENDING_MULTIPLY";break;case Kl:e="ENVMAP_BLENDING_MIX";break;case Zl:e="ENVMAP_BLENDING_ADD";break}return e}function cp(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function hp(n,e,t,i){const s=n.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=ap(t),d=op(t),c=lp(t),h=dp(t),f=cp(t),m=Jf(t),x=Qf(r),_=s.createProgram();let p,u,T=t.glslVersion?"#version "+t.glslVersion+`
...
`,So=(n,e)=>(n%e+e)%e;class tm{origin;previousTime;phase=0;speed;constructor(e,t){this.origin=e,this.previousTime=e,this.speed=t}sample(e){const t=Math.max(e,this.previousTime);return this.phase=So(this.phase+(t-this.previousTime)/1e3*this.speed,1),this.previousTime=t,{rotation:So((t-this.origin)/1e3*Hp,360),phase:this.phase}}setSpeed(e,t){this.sample(t),this.speed=e}}const ea=n=>[1,3,5].map(e=>parseInt(n.slice(e,e+2),16));function im(n,e){let t=n[0],i=t;for(const l of n){if(l.position>e){i=l;break}t=l,i=l}const s=ea(t.color),r=ea(i.color),a=i.position-t.position,o=a>0?Math.min(1,Math.max(0,(e-t.position)/a)):0;return s.map((l,d)=>Math.round(l+(r[d]-l)*o))}function nm(n,e){return"#"+im(n,e).map(t=>t.toString(16).padStart(2,"0")).join("")}function sm(n,e){const t=e.length/4,i=n.map(r=>ea(r.color));let s=0;for(let r=0;r<t;r++){const a=r/(t-1);for(;s+1<n.length&&n[s+1].position<=a;)s++;const o=Math.min(s+1,n.length-1),l=n[o].position-n[s].position,d=l>0?Math.max(0,Math.min(1,(a-n[s].position)/l)):0;for(let c=0;c<3;c++)e[r*4+c]=Math.round(i[s][c]*(1-d)+i[o][c]*d);e[r*4+3]=255}}function rm(n){return`linear-gradient(90deg, ${n.map(e=>`${e.color} ${e.position*100}%`).join(", ")})`}const ga=.25,ar=Ft*ga,or=Ht*ga,va="cover-settings-change";class fl{canvas;settings;renderer;scene=new Jr;camera=new _s(-1,1,1,-1,0,1);quad;baseTarget;pingTarget;pongTarget;waveOneTarget;waveTwoTarget;starMaterial;outputMaterial;downsampleMaterial;blurMaterial;waveMaterial;gradientTexture;gradientData;animationFrame=0;timeline;destroyed=!1;active=!0;constructor(e,t={}){if(t.outputMode!==void 0&&t.outputMode!=="black"&&t.outputMode!=="transparent")throw new TypeError("Output mode must be black or transparent.");this.settings=oi(t),this.canvas=e,this.renderer=new hl({canvas:e,alpha:!0,antialias:!1,premultipliedAlpha:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(1),this.renderer.setSize(Ft,Ht,!1),this.renderer.setClearColor(0,t.outputMode==="transparent"?0:1),this.renderer.autoClear=!1,this.baseTarget=this.createTarget(Ft,Ht),this.pingTarget=this.createTarget(ar,or),this.pongTarget=this.createTarget(ar,or),this.waveOneTarget=this.createTarget(Ft,Ht),this.waveTwoTarget=this.createTarget(Ft,Ht);const i=Math.min(4096,this.renderer.capabilities.maxTextureSize);this.gradientData=new Uint8Array(i*4),this.gradientTexture=new il(this.gradientData,i,1,Ct,Wt),this.gradientTexture.minFilter=xt,this.gradientTexture.magFilter=xt,this.gradientTexture.generateMipmaps=!1,this.updateGradient(),this.starMaterial=this.createMaterial(jp,{uResolution:{value:new ke(Ft,Ht)},uRotation:{value:0},uOuterRadius:{value:this.settings.star.outerRadius},uVertices:{value:Array.from({length:10},()=>new ke)},uGradient:{value:this.gradientTexture},uGradientSize:{value:i}}),this.updateVertices(),this.outputMaterial=this.createMaterial(t.outputMode==="transparent"?Zp:Jp,{uTexture:{value:this.baseTarget.texture}}),this.downsampleMaterial=this.createMaterial(Kp,{uTexture:{value:this.baseTarget.texture},uSourceTexel:{value:new ke(1/Ft,1/Ht)}}),this.blurMaterial=this.createMaterial(Qp,{uTexture:{value:this.pingTarget.texture},uTexelSize:{value:new ke(1/ar,1/or)},uDirection:{value:new ke(1,0)},uRadius:{value:0}}),this.waveMaterial=this.createMaterial(em,{uTexture:{value:this.baseTarget.texture},uLogicalResolution:{value:new ke(Ft,Ht)},uWavePhase:{value:0},uWaveHeight:{value:124},uWaveWidth:{value:391},uDirectionDegrees:{value:134},uWaveType:{value:0}}),this.quad=new Ot(new Hi(2,2),this.starMaterial),this.quad.frustumCulled=!1,this.scene.add(this.quad),this.timeline=new tm(performance.now(),this.settings.waveSpeed),document.addEventListener("visibilitychange",this.handleVisibility),e.addEventListener("webglcontextlost",this.handleContextLost),e.addEventListener("webglcontextrestored",this.handleContextRestored),this.animationFrame=requestAnimationFrame(this.render)}getSettings(){return structuredClone(this.settings)}setActive(e){this.destroyed||this.active===e||(this.active=e,this.handleVisibility())}setWaveSpeed(e){this.commit({...this.settings,waveSpeed:ri(e,-1,1)})}setWaveSettings(e,t){if(e!==0&&e!==1)throw new RangeError("Wave index must be 0 or 1.");const i=this.getSettings().waves;i[e]={...i[e],...t},this.commit(oi({...this.settings,waves:i}))}setBlurSettings(e){this.commit(oi({...this.settings,blur:{...this.settings.blur,...e}}))}setStarRadii(e){this.commit(oi({...this.settings,star:{...this.settings.star,...e}}))}setGradientStops(e){this.commit({...this.settings,gradientStops:ul(e)})}setGradientColors(e,t){this.setGradientStops([{id:"start",position:0,color:e},{id:"end",position:1,color:t}])}reset(){this.commit(oi())}commit(e){if(this.destroyed)return;const t=this.settings;this.settings=e,t.waveSpeed!==e.waveSpeed&&this.timeline.setSpeed(e.waveSpeed,performance.now()),(t.star.outerRadius!==e.star.outerRadius||t.star.innerRadius!==e.star.innerRadius)&&this.updateVertices(),(t.gradientStops.length!==e.gradientStops.length||e.gradientStops.some((i,s)=>i.color!==t.gradientStops[s].color||i.position!==t.gradientStops[s].position))&&this.updateGradient(),this.canvas.dispatchEvent(new CustomEvent(va,{detail:this.getSettings()}))}updateVertices(){const{outerRadius:e,innerRadius:t}=this.settings.star;this.starMaterial.uniforms.uOuterRadius.value=e,this.starMaterial.uniforms.uVertices.value.forEach((i,s)=>{const r=Math.PI/2+s*Math.PI/5,a=s%2===0?e:t;i.set(Math.cos(r)*a,Math.sin(r)*a)})}updateGradient(){sm(this.settings.gradientStops,this.gradientData),this.gradientTexture.needsUpdate=!0}destroy(){this.destroyed||(this.destroyed=!0,cancelAnimationFrame(this.animationFrame),document.removeEventListener("visibilitychange",this.handleVisibility),this.canvas.removeEventListener("webglcontextlost",this.handleContextLost),this.canvas.removeEventListener("webglcontextrestored",this.handleContextRestored),this.quad.geometry.dispose(),[this.starMaterial,this.outputMaterial,this.downsampleMaterial,this.blurMaterial,this.waveMaterial].forEach(e=>e.dispose()),[this.baseTarget,this.pingTarget,this.pongTarget,this.waveOneTarget,this.waveTwoTarget].forEach(e=>e.dispose()),this.gradientTexture.dispose(),this.renderer.dispose())}createTarget(e,t){const i=new ci(e,t,{minFilter:xt,magFilter:xt,format:Ct,type:this.renderer.extensions.has("EXT_color_buffer_float")?pn:Wt,depthBuffer:!1,stencilBuffer:!1});return i.texture.generateMipmaps=!1,i}createMaterial(e,t){return new Xt({vertexShader:Yp,fragmentShader:e,uniforms:t,depthTest:!1,depthWrite:!1,transparent:!1,blending:Kt,toneMapped:!1})}draw(e,t){this.quad.material=e,this.renderer.setRenderTarget(t),this.renderer.render(this.scene,this.camera)}handleVisibility=()=>{cancelAnimationFrame(this.animationFrame),!this.destroyed&&this.active&&!document.hidden&&!this.renderer.getContext().isContextLost()&&(this.animationFrame=requestAnimationFrame(this.render))};handleContextLost=e=>{e.preventDefault(),cancelAnimationFrame(this.animationFrame)};handleContextRestored=()=>{this.handleVisibility()};render=e=>{if(this.destroyed||!this.active)return;const{rotation:t,phase:i}=this.timeline.sample(e);this.starMaterial.uniforms.uRotation.value=t,this.waveMaterial.uniforms.uWavePhase.value=i,this.draw(this.starMaterial,this.baseTarget);let s=this.baseTarget;const{blur:r,waves:a}=this.settings;if(r.enabled&&r.radius>0){const o=r.radius<8?1:ga,l=o===1?[this.waveOneTarget,this.waveTwoTarget]:[this.pingTarget,this.pongTarget];o!==1&&(this.draw(this.downsampleMaterial,l[0]),s=l[0]),this.blurMaterial.uniforms.uTexelSize.value.set(1/l[0].width,1/l[0].height),this.blurMaterial.uniforms.uRadius.value=r.radius*o;for(let d=0;d<Gp;d++)for(let c=0;c<2;c++){const h=s===l[0]?l[1]:l[0];this.blurMaterial.uniforms.uTexture.value=s.texture,this.blurMaterial.uniforms.uDirection.value.set(c===0?1:0,c===1?1:0),this.draw(this.blurMaterial,h),s=h}}a.forEach((o,l)=>{if(!o.enabled||o.height===0)return;const d=s===this.waveOneTarget?this.waveTwoTarget:this.waveOneTarget;this.waveMaterial.uniforms.uTexture.value=s.texture,this.waveMaterial.uniforms.uWaveType.value=l,this.waveMaterial.uniforms.uWaveHeight.value=o.height,this.waveMaterial.uniforms.uWaveWidth.value=o.width,this.waveMaterial.uniforms.uDirectionDegrees.value=o.direction,this.draw(this.waveMaterial,d),s=d}),this.outputMaterial.uniforms.uTexture.value=s.texture,this.draw(this.outputMaterial,null),this.animationFrame=requestAnimationFrame(this.render)}}async function pl(n){n.classList.add("fonts-loading"),n.setAttribute("aria-busy","true");const e=document.createElement("span");e.className="deck-font-status",e.setAttribute("role","status"),e.textContent="正在加载演示字体…",n.append(e);try{await Promise.all([350,400,500,700].map(t=>document.fonts.load(`${t} 20px "Flyme Sans VF"`))),e.remove()}catch{e.textContent="演示字体加载失败，请刷新页面重试。"}finally{n.classList.remove("fonts-loading"),n.setAttribute("aria-busy","false")}}function xa(n){const e=n.startsWith("/assets/portfolio/")?".jpg":".png";return n.replace(/\.mp4$/,`-first-frame${e}`)}function ui(n){const{id:e,label:t,nodeId:i,x:s,y:r,width:a,height:o,steps:l,syncGroup:d,comparisonLabel:c,comparisonNode:h}=n,f=n.loop??!0,m=`/assets/videos/${n.asset??e}`,x=n.poster??xa(`${m}.mp4`),_=n.immersive?`--video-x:${s}px;--video-y:${r}px;--video-width:${a}px;--video-height:${o}px`:`position:absolute;left:${s}px;top:${r}px;width:${a}px;height:${o}px;border-radius:20px`;return`<div class="slide-video ${n.immersive?"lyrics-video":"slide-video--contain"} figma-frame-stroke${n.border===!1?"":" slide-video--bordered"}" data-media-id="${e}" data-play-steps="${l.join(",")}" ${d?`data-sync-group="${d}"`:""} ${n.codec?`data-codec="${n.codec}"`:""} data-node-id="${i}" style="${_}">
    ...
    </div>`).join("")}</div>`}const dm={id:"figma-2017-121463",title:"Flyme Auto 2.0：歌词海报",nodeId:"2017:121463",header:"PROJECT PORTFOLIO",stepCount:3,background:"url('/assets/figma/1927-432-gradient-0.svg')",body:`<div class="case-markers lyrics-overview"><span>01</span><span class="is-muted">02</span></div>
...
<img style="position:absolute;left:729px;top:372px;width:314px;height:1px;transform:rotate(90deg);transform-origin:0 0" width="314" height="1" data-node-id="1957:379" alt="" src="/assets/figma/1943-1085-imgLine15.svg" />`},Em={id:"figma-1957-346",title:"THS.",nodeId:"1957:346",header:"PROJECT PORTFOLIO",pageNumber:"04",background:"url('/assets/figma/1957-346-gradient-0.svg')",body:'<p style="overflow-wrap:break-word;position:absolute;font-weight:700;line-height:1.32;left:829px;font-size:128px;color:#fff;top:435px;white-space:nowrap" data-node-id="1957:364" >THS.</p>'},ys=(n,e)=>`/assets/figma/${n.replace(":","-")}-${e}.svg`,Eo=`<div class="case-markers" aria-label="项目分组：01">
  <span>01</span><span class="is-muted">02</span>
      ...
      <p class="modular-description" data-node-id="1927:430">在自己负责的核心模块，能独立完成设计和交付的工作，结合Flyme的调性和动效设计原则，输出符合Flyme Auto的动效，并通过优化工作流，提高交付效率。</p>`},dm,{id:"case-overview",title:"案例概述",nodeId:"2019:121854",header:"PROJECT PORTFOLIO",pageNumber:"05",stepCount:1,body:`${Eo}${ui({id:"case-final",label:"超级Aicy案例成片",nodeId:"2019:121875",x:141,y:219,width:1099,height:622,steps:[0],loop:!1,border:!1})}
      <h1 class="case-title" data-node-id="2019:121873">案例概述</h1>
      <p class="case-description" data-node-id="2019:121874">2026年Q2，接到给梅赛德斯奔驰做一个关于超级Aicy演示短片的紧急需求，要求在2.5天内完成从设计稿到动画成片的交付。我负责影片重90%的动效设计以及整体的串联工作。通过规划合理的叙事节奏，模块化工程结构，在有限的时间内按期完成并高质量交付。</p>`},hm,um,fm,pm,gm,mm,vm,xm,cm,_m,ym,bm,Sm,wm,Em],ta=n=>n?String(n).padStart(2,"0"):"";function Mm(){return Xe.map(ml).join("")}function ml(n,e){return am(`<section class="slide slide--${n.id}" data-slide-id="${n.id}" data-slide-index="${e}" data-step="0" data-node-id="${n.nodeId}" ${n.background?`style="background-image:${n.background}"`:""} aria-label="第 ${e+1} 张：${n.title}" ${e?"hidden inert":""}>
...
`;class Nm{constructor(e,t,i,s,r={}){this.canvas=e,this.errors=i,this.announce=s,this.renderOptions=r,this.settings=Mn(t),this.paused=this.reduceQuery.matches,this.placeholder.needsUpdate=!0,this.renderer=new hl({canvas:e,alpha:!0,antialias:!0,premultipliedAlpha:!0}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,2)),this.renderer.setClearColor(0,0),this.outputMaterial=new Xt({vertexShader:Ro,fragmentShader:Um,depthTest:!1,depthWrite:!1,blending:Kt,uniforms:{uWall:{value:this.target.texture},uScale:{value:this.settings.size/100},uConcavity:{value:this.settings.concavity/100},uSourceLeft:{value:0},uSourceWidth:{value:1920}}}),this.updateView(),this.outputScene.add(new Ot(this.outputGeometry,this.outputMaterial)),this.mediaRoot.hidden=!0,this.mediaRoot.className="wall-lab-media",e.parentElement.append(this.mediaRoot),Fi.forEach((o,l)=>o.cards.forEach(d=>this.addWork(l,d))),this.ready=Promise.all(this.posterLoads).then(()=>{});const a={signal:this.events.signal};e.addEventListener("pointermove",o=>{o.pointerType!=="mouse"||!this.hoverQuery.matches||(this.pointer={x:o.clientX,y:o.clientY})},a),e.addEventListener("pointerleave",()=>{this.pointer=void 0},a),e.addEventListener("pointercancel",()=>{this.pointer=void 0},a),window.addEventListener("blur",()=>{this.pointer=void 0},a),document.addEventListener("visibilitychange",()=>{this.previousTime=void 0,this.pointer=void 0,document.hidden?(this.cancelFrame(),this.works.forEach(o=>this.pauseWork(o))):this.schedule()},a),this.reduceQuery.addEventListener("change",()=>{this.setPaused(this.reduceQuery.matches),this.announce(this.paused?"已按“减少动态效果”暂停；可手动查看下一组。":"已恢复动态预览。")},a),e.addEventListener("webglcontextlost",o=>{o.preventDefault(),this.contextLost=!0,this.cancelFrame(),this.works.forEach(l=>this.pauseWork(l)),this.announce("显卡绘制已中断，请刷新此调试页恢复；已保存的参数会保留。")},a),e.addEventListener("webglcontextrestored",()=>{this.contextLost=!1,this.previousTime=void 0,this.schedule(),this.announce("绘制已恢复。")},a),this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(e),this.resize(),this.schedule()}canvas;errors;announce;renderOptions;renderer;target=new ci(1920,1080,{depthBuffer:!1,stencilBuffer:!1});scene=new Jr;camera=new _s(0,1920,1080,0,-1,1);outputScene=new Jr;outputCamera=new _s(-1,1,1,-1,-1,1);outputMaterial;outputGeometry=new Hi(2,2);works=[];posterLoads=[];ready;distances=Fi.map(()=>0);events=new AbortController;resizeObserver;hoverQuery=matchMedia("(hover: hover) and (pointer: fine)");reduceQuery=matchMedia("(prefers-reduced-motion: reduce)");mediaRoot=document.createElement("div");placeholder=new il(new Uint8Array([10,16,23,255]),1,1);pointer;previousTime;frame=0;destroyed=!1;contextLost=!1;paused=!1;settings;view=Ao(100);getSettings(){return{...this.settings}}setSettings(e){const t=this.settings.size;this.settings=Mn(e),t!==this.settings.size&&this.updateView()}isPaused(){return this.paused}setPaused(e){this.paused=e,this.previousTime=void 0,e&&this.works.forEach(t=>this.pauseWork(t))}nextGroup(){this.distances.forEach((e,t)=>{this.distances[t]+=st.small+st.gap})}captureStill(){if(this.destroyed||this.contextLost)return"";const e=this.works.map(i=>({map:i.mesh.material.uniforms.uMap.value,aspect:i.mesh.material.uniforms.uAspect.value}));this.draw(0,!0);const t=this.canvas.toDataURL("image/png");return this.works.forEach((i,s)=>{i.mesh.material.uniforms.uMap.value=e[s].map,i.mesh.material.uniforms.uAspect.value=e[s].aspect}),this.renderOptions.staticOnly||this.draw(0),t}getState(){return{settings:this.getSettings(),paused:this.paused,destroyed:this.destroyed,view:{...this.view},cards:this.works.map(e=>({id:e.id,row:e.row,x:e.x,visible:e.visible,playing:!e.video.paused,time:e.video.currentTime,failed:e.failed,hover:e.hover}))}}destroy(){if(!this.destroyed){this.destroyed=!0,this.cancelFrame(),this.events.abort(),this.resizeObserver.disconnect();for(const e of this.works)this.pauseWork(e),e.video.removeAttribute("src"),e.video.load(),e.texture?.dispose(),e.poster.dispose(),e.mesh.material.dispose(),e.mesh.geometry.dispose(),e.errorElement.remove();this.mediaRoot.remove(),this.placeholder.dispose(),this.target.dispose(),this.outputMaterial.dispose(),this.outputGeometry.dispose(),this.renderer.dispose(),this.renderer.forceContextLoss()}}addWork(e,t){const i=new Xt({vertexShader:Ro,fragmentShader:Im,transparent:!0,depthTest:!1,depthWrite:!1,premultipliedAlpha:!0,blending:Io,blendSrc:Uo,blendDst:gs,uniforms:{uMap:{value:this.placeholder},uSize:{value:new ke(t.width,st.height)},uAspect:{value:t.wide?3.2:1.6},uRadius:{value:st.radius},uStroke:{value:st.stroke},uPointer:{value:new ke(-1e4,-1e4)},uHover:{value:0}}}),s=new Ot(new Hi(t.width+32,st.height+32),i);s.position.y=1080-Fi[e].top-st.height/2,s.frustumCulled=!1,this.scene.add(s);const r=document.createElement("video");r.dataset.workId=t.id,r.muted=!0,r.defaultMuted=!0,r.poster=In(xa(`/assets/portfolio/${t.id}.mp4`)),r.playsInline=!0,r.loop=!0,r.preload="none",this.mediaRoot.append(r);const a=document.createElement("li");a.hidden=!0;const o=document.createElement("span");o.textContent=`${t.label}：暂时无法播放，已保留封面`;const l=document.createElement("button");l.textContent="重试",l.type="button",a.append(o,l),this.errors.append(a);const d={id:t.id,label:t.label,row:e,width:t.width,offset:t.offset,x:0,mesh:s,video:r,poster:new pt,visible:!1,prepared:!1,pending:!1,failed:!1,token:0,hover:0,errorElement:a};this.works.push(d),d.poster.dispose();let c;this.posterLoads.push(new Promise(f=>{c=f})),d.poster=new ec().load(r.poster,f=>{if(c(),this.destroyed){f.dispose();return}(!d.texture||r.readyState<2||d.failed)&&(i.uniforms.uMap.value=f,i.uniforms.uAspect.value=f.image.width/f.image.height)},void 0,()=>{c(),this.destroyed||this.announce(`${t.label}封面加载失败；视频就绪后仍可播放。`)});const h={signal:this.events.signal};l.addEventListener("click",()=>{this.pauseWork(d),d.failed=!1,d.errorElement.hidden=!0,r.load(),this.syncErrors(),this.prepare(d)},h),r.addEventListener("playing",()=>{if(this.destroyed||document.hidden||this.paused||!d.visible){r.pause();return}d.pending=!1,d.errorElement.hidden=!0,this.syncErrors(),i.uniforms.uMap.value=d.texture,i.uniforms.uAspect.value=r.videoWidth/r.videoHeight},h),r.addEventListener("error",()=>{d.prepared&&this.fail(d)},h)}prepare(e){e.prepared||e.failed||(e.prepared=!0,e.video.preload="auto",e.video.src=In(`assets/portfolio/${e.id}.mp4`),e.texture=new Yd(e.video),e.video.load())}play(e){if(e.pending||e.failed||!e.video.paused)return;this.prepare(e);const t=++e.token;e.pending=!0,e.video.play().catch(i=>{if(!(this.destroyed||t!==e.token||!e.visible||this.paused||document.hidden)){if(i instanceof DOMException&&i.name==="AbortError"){e.pending=!1;return}this.fail(e)}})}pauseWork(e){++e.token,e.pending=!1,e.video.pause()}fail(e){this.pauseWork(e),e.failed=!0,e.mesh.material.uniforms.uMap.value=e.poster.image?e.poster:this.placeholder;const t=e.poster.image;t&&(e.mesh.material.uniforms.uAspect.value=t.width/t.height),e.errorElement.hidden=!1,this.syncErrors()}syncErrors(){this.errors.hidden=!this.works.some(e=>!e.errorElement.hidden)}updateView(){this.view=Ao(this.settings.size),this.target.setSize(this.view.renderWidth,1080),this.camera.left=this.view.renderLeft,this.camera.right=this.view.renderLeft+this.view.renderWidth,this.camera.updateProjectionMatrix(),this.outputMaterial.uniforms.uSourceLeft.value=this.view.renderLeft,this.outputMaterial.uniforms.uSourceWidth.value=this.view.renderWidth}resize(){const e=this.canvas.getBoundingClientRect();this.renderer.setSize(Math.max(1,Math.round(e.width)),Math.max(1,Math.round(e.height)),!1)}cancelFrame(){cancelAnimationFrame(this.frame),this.frame=0}schedule(){!this.renderOptions.staticOnly&&!this.destroyed&&!document.hidden&&!this.contextLost&&!this.frame&&(this.frame=requestAnimationFrame(this.tick))}tick=e=>{if(this.frame=0,this.destroyed||document.hidden||this.contextLost)return;const t=this.previousTime===void 0?0:Math.min(.1,(e-this.previousTime)/1e3);this.previousTime=e,this.draw(t),this.schedule()};draw(e,t=!1){!t&&!this.paused&&this.distances.forEach((r,a)=>{this.distances[a]=(this.distances[a]+this.settings.speed*e/(this.settings.size/100))%Fi[a].length});const i=this.canvas.getBoundingClientRect(),s=!t&&this.pointer&&Dm((this.pointer.x-i.left)*1920/i.width,(this.pointer.y-i.top)*1080/i.height,this.settings);for(const r of this.works){const a=Fi[r.row];r.x=this.view.left+_a(a.origin+r.offset+a.direction*(t?0:this.distances[r.row])-this.view.left,r.width,a.length),r.mesh.position.x=r.x+r.width/2,r.visible=r.x<this.view.right&&r.x+r.width>this.view.left,r.mesh.visible=r.x<this.view.right+16&&r.x+r.width>this.view.left-16;const o=r.x<this.view.right+160&&r.x+r.width>this.view.left-160;t?(r.mesh.material.uniforms.uMap.value=r.poster.image?r.poster:this.placeholder,r.poster.image&&(r.mesh.material.uniforms.uAspect.value=r.poster.image.width/r.poster.image.height)):(!this.paused&&o&&this.prepare(r),!this.paused&&r.visible?this.play(r):(r.pending||!r.video.paused)&&this.pauseWork(r));const l=!!s&&r.visible&&s.x>=r.x&&s.x<=r.x+r.width&&s.y>=a.top&&s.y<=a.top+st.height;l&&r.mesh.material.uniforms.uPointer.value.set(s.x-r.x,s.y-a.top);const d=l?1:0;t||(r.hover=this.reduceQuery.matches?d:r.hover+(d-r.hover)*Math.min(1,e/(l?.2:.3))),r.mesh.material.uniforms.uHover.value=t?0:r.hover}this.outputMaterial.uniforms.uScale.value=this.settings.size/100,this.outputMaterial.uniforms.uConcavity.value=this.settings.concavity/100,this.renderer.setRenderTarget(this.target),this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.renderer.setRenderTarget(null),this.renderer.clear(),this.renderer.render(this.outputScene,this.outputCamera)}}var Co={speed:30,size:100,concavity:0,showChrome:!0};class Fm{constructor(e,t,i,s,r=!1){this.root=e,this.editable=s,this.shared=r,this.settings=this.load(),this.page=t.querySelector(".slide--portfolio-wall"),this.original=this.page.querySelector(".portfolio-wall"),this.fallback=new Pm(t,i),this.layer.className="curved-portfolio-layer",this.layer.hidden=!0,this.canvas.className="curved-portfolio-canvas",this.canvas.setAttribute("aria-label","双向流动的内凹作品墙"),this.errors.className="curved-portfolio-errors",this.errors.hidden=!0,this.notice.className="curved-portfolio-notice",this.notice.setAttribute("role","status"),this.layer.append(this.canvas,this.errors,this.notice),this.page.append(this.layer),this.still.className="curved-portfolio-still",this.still.alt="内凹作品墙静态预览",this.still.hidden=!0,this.page.append(this.still);for(const o of e.querySelectorAll(".slide-preview-content.slide--portfolio-wall")){const l=this.still.cloneNode();o.append(l),this.previews.push(l)}const a={signal:this.events.signal};s&&(this.createControls(),this.launcher.addEventListener("click",()=>this.showPanel(!0),a),this.panel.querySelector("[data-wall-close]").addEventListener("click",()=>this.showPanel(!1),a),this.panel.querySelector("[data-wall-reset]").addEventListener("click",()=>{this.settings={...ia},this.changed()},a),this.panel.addEventListener("input",o=>{const l=o.target,d=l.dataset.wallRange??l.dataset.wallNumber;if(!d||!Number.isFinite(l.valueAsNumber))return;const c=d,[h,f]=En[c];l.type==="number"&&(l.valueAsNumber<h||l.valueAsNumber>f)||(this.settings=Mn({...this.settings,[d]:l.valueAsNumber}),this.changed())},a),this.panel.addEventListener("focusout",o=>{const l=o.target;l.dataset.wallNumber&&(Number.isFinite(l.valueAsNumber)?(this.settings=Mn({...this.settings,[l.dataset.wallNumber]:l.valueAsNumber}),this.changed()):this.syncControls())},a),window.addEventListener("keydown",o=>{!this.enabled||this.slideId!==ms||o.defaultPrevented||Es(o)||o.repeat||o.ctrlKey||o.metaKey||o.altKey||document.querySelector("dialog[open]")||(o.key.toLowerCase()==="h"||o.key==="Escape"&&!this.panel.hidden)&&(o.preventDefault(),o.stopImmediatePropagation(),this.showPanel(o.key==="Escape"?!1:this.panel.hidden))},{...a,capture:!0})),window.addEventListener("storage",o=>{this.shared||o.key!==lr||this.dirty||(this.settings=this.load(),this.renderer?.setSettings(this.settings),this.syncControls(),this.queuePreview())},a),document.addEventListener("visibilitychange",()=>{document.hidden&&this.save()},a),this.reduced.addEventListener("change",()=>this.sync(),a),this.syncControls()}root;editable;shared;page;original;layer=document.createElement("div");canvas=document.createElement("canvas");errors=document.createElement("ul");notice=document.createElement("p");still=document.createElement("img");panel=document.createElement("aside");launcher=document.createElement("button");events=new AbortController;reduced=matchMedia("(prefers-reduced-motion: reduce)");fallback;renderer;rendererLive=!1;settings;slideId="";enabled=!1;failed=!1;destroyed=!1;saveTimer=0;previewTimer=0;dirty=!1;preview="";previews=[];update(e,t){e===this.enabled&&t===this.slideId||(this.save(),this.enabled=e,this.slideId=t,this.sync())}destroy(){this.destroyed||(this.save(),this.destroyed=!0,this.events.abort(),clearTimeout(this.previewTimer),this.renderer?.destroy(),this.renderer=void 0,this.fallback.destroy(),this.layer.remove(),this.still.remove(),this.panel.remove(),this.launcher.remove(),this.previews.forEach(e=>e.remove()),this.original.hidden=!1,this.original.inert=!1)}sync(){if(this.destroyed)return;const e=this.slideId===ms,t=e&&this.enabled,i=this.failed||this.reduced.matches;if(this.fallback.update(t&&i,this.slideId),this.launcher.hidden=!this.editable||!t,t||this.showPanel(!1,!1),(!e||i||this.rendererLive!==t)&&this.renderer&&(this.renderer.destroy(),this.renderer=void 0,clearTimeout(this.previewTimer)),this.layer.hidden=!e||i,this.original.hidden=!i&&(t||!!this.preview),this.original.inert=this.original.hidden,this.still.hidden=!e||t||i||!this.preview,this.canvas.hidden=!t,e&&!i&&!this.renderer&&(t||!this.preview)){const s=this.canvas.cloneNode();this.canvas.replaceWith(s),this.canvas=s,this.canvas.hidden=!1;try{const r=new Nm(this.canvas,this.settings,this.errors,a=>{this.notice.textContent=a},{staticOnly:!t});this.renderer=r,this.rendererLive=t,r.ready.then(()=>{this.renderer!==r||this.destroyed||(this.refreshPreview(),this.enabled||(r.destroy(),this.renderer=void 0,this.canvas.hidden=!0,this.still.hidden=!1,this.original.hidden=!0,this.original.inert=!0))})}catch{this.failed=!0,this.notice.textContent="此浏览器无法绘制内凹效果，已恢复原作品墙。",this.original.hidden=!1,this.original.inert=!1,this.layer.hidden=!0,this.fallback.update(t,this.slideId)}}this.reduced.matches?this.status("已按“减少动态效果”使用静态平面作品墙，可横向滚动查看。"):this.failed&&this.status("当前浏览器无法绘制内凹效果，已恢复原作品墙。")}refreshPreview(){if(!this.renderer||this.destroyed)return;const e=this.renderer.captureStill();if(e){this.preview=e,this.still.src=e;for(const t of this.previews){t.src=e,t.hidden=!1;const i=t.parentElement.querySelector(".portfolio-wall");i.hidden=!0}}}queuePreview(){clearTimeout(this.previewTimer),this.previewTimer=window.setTimeout(()=>this.refreshPreview(),250)}changed(){this.renderer?.setSettings(this.settings),this.syncControls(),this.queuePreview(),this.dirty=!0,this.status("正在保存参数…"),clearTimeout(this.saveTimer),this.saveTimer=window.setTimeout(()=>this.save(),200)}save(){if(clearTimeout(this.saveTimer),!!this.dirty)try{localStorage.setItem(lr,JSON.stringify({version:1,settings:this.settings})),this.dirty=!1,this.status("已自动保存到此浏览器")}catch{this.status("参数已生效，但未能保存；请保持本页打开。")}}load(){if(this.shared&&typeof Co<"u")return{...Co};try{const e=JSON.parse(localStorage.getItem(lr)??"null");if(e?.version===1)return Mn(e.settings)}catch{}return{...ia}}status(e){const t=this.panel.querySelector("[data-wall-status]");t&&(t.textContent=e)}showPanel(e,t=!0){if(!this.editable)return;const i=e&&this.enabled&&this.slideId===ms;this.panel.hidden=!i,this.launcher.setAttribute("aria-expanded",String(i)),t?(i?this.panel.querySelector("[data-wall-close]"):this.launcher).focus({preventScroll:!0}):this.panel.contains(document.activeElement)&&document.activeElement instanceof HTMLElement&&document.activeElement.blur()}syncControls(){for(const e of Object.keys(En))this.panel.querySelectorAll(`[data-wall-range="${e}"], [data-wall-number="${e}"]`).forEach(t=>{t.value=String(this.settings[e])})}createControls(){this.launcher.type="button",this.launcher.id="wall-debug-toggle",this.launcher.className="portfolio-debug-launcher",this.launcher.innerHTML="作品墙调试 <kbd>H</kbd>",this.launcher.hidden=!0,this.launcher.setAttribute("aria-controls","wall-debug-panel"),this.launcher.setAttribute("aria-expanded","false"),this.panel.id="wall-debug-panel",this.panel.className="controls portfolio-controls",this.panel.hidden=!0,this.panel.setAttribute("aria-label","作品墙调试"),this.panel.innerHTML=`<header class="controls__header"><div><p class="controls__eyebrow">PORTFOLIO WALL</p><h1>作品墙调试</h1></div>
      ...
      <footer class="controls__footer"><span data-wall-status role="status">参数自动保存</span><button type="button" data-wall-reset>恢复默认值</button></footer>`,this.root.append(this.launcher,this.panel)}}class Om{page;expand;text;events=new AbortController;enabled=!1;constructor(e,t){this.page=e.querySelector(".slide--figma-2017-121463"),this.expand=this.page.querySelector(".video-expand"),this.text=this.page.querySelector(".lyrics-principles"),this.expand.addEventListener("click",()=>{this.enabled&&this.page.dataset.step==="0"&&t()},{signal:this.events.signal}),this.expand.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&i.stopPropagation()},{signal:this.events.signal})}update(e,t,i){const s=t==="figma-2017-121463";this.enabled=e&&s;const r=this.enabled&&i===0;!r&&document.activeElement===this.expand&&this.expand.blur(),this.expand.disabled=!r,this.expand.tabIndex=r?0:-1,this.expand.setAttribute("aria-hidden",String(!r)),this.text.setAttribute("aria-hidden",String(!s||i!==2)),this.page.classList.toggle("lyrics-static",!e)}destroy(){this.events.abort()}}const kn="presentation-slide-change",_l="presentation-position-change";class yl{constructor(e,t={}){this.root=e,this.options=t,e.className="presentation-app",e.innerHTML=`<div class="deck-viewport"><div class="deck-stage">${Mm()}</div></div>
