...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Ga(){return new ci({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ea(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Va(){return new ci({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ea(),fragmentShader:`
